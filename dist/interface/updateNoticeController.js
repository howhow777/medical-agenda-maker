...
export class UpdateNoticeController {
    constructor() {
        this.storageKey = 'medical-agenda-maker:update-notice:2026-09-16-roof-defaults';
        this.snoozeKey = 'medical-agenda-maker:update-notice:2026-09-16-roof-defaults:snoozed';
        ...
        this.currentTab = document.getElementById('updateNoticeCurrentTab');
        this.previousTab = document.getElementById('updateNoticePreviousTab');
        this.readMoreButton = document.getElementById('updateNoticeReadMore');
    ...
    selectPeriod(period) {
        if (!this.currentTab || !this.previousTab || !this.panel || !this.title || !this.summary || !this.items)
            return;
    ...
    setDetailsExpanded(expanded) {
        if (!this.details || !this.readMoreButton)
            return;
