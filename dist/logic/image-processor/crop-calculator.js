...
export class CropCalculator {
     ...
     * @param options - 裁切選項
     */
    static constrainRect(rect, bounds, options = {}) {
     ...
     * @param options - 裁切選項
     */
    static applyDrag(startRect, dragType, deltaX, deltaY, bounds, options = {}) {
     ...
     */
    static getDefaultCropRect(imageBounds, padding = 0.1) {
...
//# sourceMappingURL=crop-calculator.js.map