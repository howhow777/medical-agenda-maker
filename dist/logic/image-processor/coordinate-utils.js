...
export class CoordinateUtils {
     ...
     */
    static displayToNatural(displayRect, naturalSize, displaySize, displayOffset) {
     ...
     * 將自然圖片座標轉換為顯示座標
     */
    static naturalToDisplay(naturalRect, naturalSize, displaySize, displayOffset) {
     ...
     * @param margin - 邊距
     */
    static calculateDisplayLayout(naturalSize, containerSize, margin = 24) {
     ...
     * 限制矩形在指定尺寸範圍內
     */
    static clampToSize(rect, bounds) {
