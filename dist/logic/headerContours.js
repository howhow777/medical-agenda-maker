...
export function drawClassicRoof(ctx, width, fill) {
    ctx.save();
    ctx.beginPath();
...
export function renderClassicRoofPreview(canvas, colors) {
    ...
    const palette = (colors.length >= 2 ? colors : ['#347F91', '#A7DDE1']);
