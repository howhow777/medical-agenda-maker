...
export const templates: Record<string, CancerTemplate> = {
  ...
  urinary: {
    ...
    sampleItems: [
      { time: '08:30-09:00', topic: '報到註冊', speaker: '', moderator: '' },
      { time: '09:00-09:30', topic: '膜胱癌診斷與分期', speaker: '泌尿科主任', moderator: '影像醫學科醫師' },
      { time: '09:30-10:30', topic: '腮臟癌標靴治療', speaker: '腫瘤科醫師', moderator: '藥劑師' },
      { time: '10:30-11:00', topic: '休息時間', speaker: '', moderator: '' },
  ...
  breast: {
    ...
    sampleItems: [
      { time: '08:30-09:00', topic: '報到註冊', speaker: '', moderator: '' },
      { time: '09:00-09:30', topic: '乳癌基因檢測與風險評估', speaker: '乳房外科主任', moderator: '遺傳諢詢師' },
