...
export class FileUploader {
  private parser: ExcelAgendaParser;
  private onDataParsed?: (data: AgendaData) => void;
   ...
   * 設定資料解析完成的回調
   */
  setOnDataParsed(callback: (data: AgendaData) => void) {
   ...
   * 顯示成功結果
   */
  private showSuccess(data: AgendaData) {
    const statusEl = document.getElementById('upload-status');
