...
This is a static single-page TypeScript application with no client-side router.

| URL | Entry | Layout |
| --- | --- | --- |
| `/` | `index.html` → `dist/main.js` | AppShell |
| `/index.html` | `index.html` → `dist/main.js` | AppShell |
